...
class GameGrid:
    ...
    def __init__(self, grid_h, grid_w):
        ...
        self.empty_cell_color = Color(230, 219, 213)
        # set the colors used for the grid lines and the grid boundaries
        self.line_color = Color(110, 71, 54)
        self.boundary_color = Color(54, 36, 28)
    ...
    def drawScore(self, score=0):
        ...
        stddraw.setPenColor(Color(59, 41, 28))
    ...
    def display_info(self, txt, count):
        ...
        stddraw.text(15.8, 5, text_to_display)
